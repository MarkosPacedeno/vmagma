"""
Django settings for gamepromo project.
...
SECRET_KEY = 'django-insecure-y!vamqvwq@l5ggnfu8t5%icxq&fr7i(r50x%1i+z)ps7bi!n^o'
...
WSGI_APPLICATION = 'gamepromo.wsgi.application'
